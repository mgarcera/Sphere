...
final class WeatherService {
    ...
    private var byHour: [Date: SkyCondition] = [:]
    ...
    func load(coordinate: Coordinate) async {
        ...
        do {
            ...
            byHour = Dictionary(hours.map { ($0.date, $0.condition) }, uniquingKeysWith: { first, _ in first })
    ...
    /// forecast window.
    func condition(at date: Date) -> SkyCondition? {
